...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Solar Vibes SA | Solar Panel Cleaning & Maintenance" },
      {
        name: "description",
        content:
          "Professional solar panel cleaning, maintenance and protection in San Antonio, Texas.",
      },
      { name: "author", content: "Solar Vibes SA" },
